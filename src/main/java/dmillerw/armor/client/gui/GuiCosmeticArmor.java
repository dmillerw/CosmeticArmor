...
public class GuiCosmeticArmor extends InventoryEffectRenderer {
    ...
    public GuiCosmeticArmor(EntityPlayer player) {
        super(new ContainerCosmeticArmor(player, !player.worldObj.isRemote));
    ...
    protected void keyTyped(char par1, int par2) {
        if (par2 == KeyHandler.KEY_COSMETIC_INVENTORY.getKeyCode()) {
